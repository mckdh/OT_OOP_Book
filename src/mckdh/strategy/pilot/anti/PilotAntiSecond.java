...
public class PilotAntiSecond {
	protected AirplaneAntiStrategySecond airplane = null;
	protected boolean checkResult;
	protected boolean turnOnResult;
	protected boolean increaseSpeedResult;
	
	public PilotAntiSecond(AirplaneAntiStrategySecond airplane) {
		this.airplane = airplane;
	}
	
	// 파일럿이 비행기(조종석)에 올라탄다.
	public AirplaneAntiStrategySecond intoCockpit() {
